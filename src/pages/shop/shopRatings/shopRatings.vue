    ...
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        ...
        <div class="switch" :class="{on: onlyShowText}" @click="toggleOnlyShowText">
          <span class="iconfont iconcheck-circle-fill"></span>
        ...
        <ul>
          <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont" :class="rating.rateType===0 ? 'iconicon-thumb-up' : 'iconicon-thumb-down'"></span>
...
export default {
  data () {
    return {
      ...
      selectType: 2 // 选择评论类型 0: 满意 1: 不满意 2: 全部
    }
  },
  ...
  computed: {
    ...
    filterRatings () {
      ...
      return ratings.filter(rating => {
         ...
         *        selectType:0/1/2
         *        rateType:0/1
         *        当满足下面条件时，才返回为rating的值
         *        selectType===2 或者 rateType===selectType
         * 条件2:
         *        onluShowText:true/false
         *        text:有值/没值
         *        !onlyShowText (当onlyShowText为false时，取反就会直接为true，会直接返回所有值) 或者
         *        text.length>0 （当onlyShowText为true时，只显示有文本的，就说明文本有长度）
         */
